...
conn <- dbConnect(driver,dbname="../../../camera_db/db_attack_trafic_features_bnl800_bks300.db")
...
cols_remove = as.character(plotFrame$Variable[which(plotFrame$IV<0.1)])
cols_keep = as.character(plotFrame$Variable[which(plotFrame$IV>=0.1)])
save(cols_keep,file = "demo2/cols_keep.RData")
all_data = all_data %>% select(cols_keep,Timestamp,t_label,anomaly,attack)
str(all_data)

# ggplot(data=all_data,aes(x=Timestamp,y=f_mn_cx_xs,color = as.factor(anomaly)))+geom_point()##This
# ggplot(data=all_data,aes(x=Timestamp,y=f_sd_cx_xs,color = as.factor(anomaly)))+geom_point()
# ggplot(data=all_data,aes(x=Timestamp,y=f_sd_tg_dx_b1,color = as.factor(anomaly)))+geom_point()
# ggplot(data=all_data,aes(x=Timestamp,y=f_fr_dx_tb_b1,color = as.factor(anomaly)))+geom_point()##This
# ggplot(data=all_data,aes(x=Timestamp,y=f_fr_dx_tb_b0,color = as.factor(anomaly)))+geom_point()##This

# ggplot(data=all_data,aes(x=Timestamp,y=f_time_window,color = as.factor(anomaly)))+geom_point() +ylim(0,10)##This
ggplot(data=all_data,aes(x=Timestamp,y=f_sd_dx_xs,color = as.factor(attack)))+geom_point() #THis
ggplot(data=all_data,aes(x=Timestamp,y=f_fr_dx_tb_b1,color = as.factor(attack)))+geom_point()
ggplot(data=all_data,aes(x=Timestamp,y=f_fr_dx_tb_b0,color = as.factor(attack)))+geom_point()#THis?
ggplot(data=all_data,aes(x=Timestamp,y=f_mn_xs_dx_b0,color = as.factor(attack)))+geom_point()
ggplot(data=all_data,aes(x=Timestamp,y=f_mn_tg_dx_b0,color = as.factor(attack)))+geom_point()+ylim(0,1)
ggplot(data=all_data,aes(x=Timestamp,y=f_sd_xs_dx_b0,color = as.factor(attack)))+geom_point()
ggplot(data=all_data,aes(x=Timestamp,y=f_sd_tg_dx_b0,color = as.factor(attack)))+geom_point()
ggplot(data=all_data,aes(x=Timestamp,y=c_c_dx ,color = as.factor(attack)))+geom_point()##This
ggplot(data=all_data,aes(x=Timestamp,y=f_fr_dx_x ,color = as.factor(attack)))+geom_point()##This
ggplot(data=all_data,aes(x=Timestamp,y=c_c_cx ,color = as.factor(attack)))+geom_point()##This
...
save_model_hdf5(model_cam,"model_demo.hdf5")
